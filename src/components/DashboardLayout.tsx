...
import { Calendar, Users, Settings, FileText, Clock, BarChart, Crown, Trophy, UserCheck, Globe } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Webhook Logs", url: "/dashboard/webhook-logs", icon: Globe },
