...
import { Calendar, Users, Settings, FileText, Clock, BarChart, Crown, Trophy, UserCheck, CreditCard } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Histórico Pagamentos", url: "/dashboard/historico-pagamentos", icon: CreditCard },
