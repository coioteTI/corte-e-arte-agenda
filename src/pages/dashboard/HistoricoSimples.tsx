  ...
  const aplicarFiltros = () => {
    ...
    if (filtroData) {
      ...
      servicosFiltrados = servicosFiltrados.filter(
        (servico) => servico.appointment_date === dataFormatada
      );
    }
    ...
    if (filtroStatusPagamento !== "todos") {
      servicosFiltrados = servicosFiltrados.filter(
        (servico) => servico.payment_status === filtroStatusPagamento
      );
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {filtroData
                        ? format(filtroData, "PPP", { locale: ptBR })
                        : "Selecione uma data"}
                    </Button>
                  </PopoverTrigger>
              ...
              >
                ...
                <SelectContent>
                  ...
                  {Array.from(
                    new Set(servicos.map((s) => s.professional_name))
                  ).map((name) => (
              ...
              <Select
                ...
                onValueChange={setFiltroStatusPagamento}
              >
                <SelectTrigger>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {format(new Date(servico.appointment_date), "dd/MM/yyyy", {
                            locale: ptBR,
                          })}{" "}
                          às {servico.appointment_time}
                        </span>
                      </div>
                    </div>
